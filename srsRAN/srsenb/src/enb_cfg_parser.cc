...
int parse_sib10(std::string filename, sib_type10_s* data)
{
  ...
  std::string warning_type_s;
  bool        warning_type_enable;
  ...
  sib10.add_field(new parser::field<std::string>("warning_type", &warning_type_s, &warning_type_enable));
  if (warning_type_enable) {
    if (warning_type_s.size() > 48) {
      warning_type_s.resize(48);
    }
    data->warning_type.from_string(warning_type_s);
  }
